...
JOIN
	compras c ON c.id = s.foreign_key and c.tipo in (33,34) and c.estado_compra_id NOT IN (3,4) -- Solo FAC-EL y FAC-EE --
WHERE 
	s.modelo = 'Compra'
...
JOIN
    ...
    and e.razon_social NOT LIKE '%stark%' -- Empresas activas y quitando Chipax (8) y starks --
JOIN
	dtes d ON d.id = s.foreign_key and d.tipo in (33,34) -- Solo FAC-EL y FAC-EE --
WHERE 
	s.modelo = 'Dte'
